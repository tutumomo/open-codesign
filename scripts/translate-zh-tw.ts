...
async function translateBatch(batch: FlatMap): Promise<FlatMap> {
...
Rules:
- Keep JSON keys exactly as-is (they use dot notation like "section.subsection.key")
- Translate only the values
- Use Taiwan Mandarin conventions (e.g., 軟體 not 軟件, 檔案 not 文件, 設定 not 設置)
- Preserve any placeholders like {{variable}}, {0}, %s, <tag> exactly as they appear
